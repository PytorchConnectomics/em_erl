...
- Reproduced FFN's result on j0126 dataset ([Januszewski et. al 2018](https://www.nature.com/articles/s41592-018-0049-4)): `examples/README.md` 
...
- Naive ERL evaluation (defined in the [FFN paper](https://www.nature.com/articles/s41592-018-0049-4))
  - `python examples/eval_volume.py -p tests/data/vol_pred.h5 -g tests/data/gt_graph.npz -r 30,30,30`
...
- Merge-tolerant false-merge handling (`--merge-threshold`)
  - `python examples/eval_volume.py -p <pred.h5> -g <gt_graph.npz> -r 30,30,30 -m <no_merge_mask.h5> -t 30`
...
```
python examples/eval_volume.py -p pred.h5 -g gt_graph.npz -r 30,30,30 \
